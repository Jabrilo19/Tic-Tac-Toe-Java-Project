...
This project is a command-line Tic-Tac-Toe game built in Java, originally featuring a simple computer opponent that selected moves at random. I have improved the computer opponent with an Minimax AI so it can live up to it's "unbeatable" title.
